...
export default class CustomTournamentPong extends HTMLElement {
	constructor()
	{
		super();
	}
	...
	{
		let players = await lang.tournaments.players[getCookie("lang")];
				...
				<div class="container d-flex justify-content-center align-items-center" id="divTournament">
					<form id="tournament-form">
						<div class="form-check">
							...
							<label class="form-check-label" for="4">4 ${players}</label>
						</div>
						<div class="form-check">
							<input class="form-check-input" type="radio" value="8" id="8" name="nbPlayers">
							<label class="form-check-label" for="8">8 ${players}</label>
						</div>
						<div class="form-check">
							<input class="form-check-input" type="radio" value="16" id="16" name="nbPlayers">
							<label class="form-check-label" for="16">16 ${players}</label>
						</div>
		...
		{
			const content = document.querySelector("local-pong-tournament");
...
//TODO ERROR MESSAGE
		...
		async function LaunchGame(PlayerTab, i)
		{
			...
			const body = document.querySelector("local-pong-tournament");
		...
		{
			let content = document.querySelector("local-pong-tournament");
			const LaunchGame = document.createElement("local-pong");
