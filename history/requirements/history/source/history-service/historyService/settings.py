"""
Django settings for historyService project.
...
ROOT_URLCONF = 'historyService.urls'
...
WSGI_APPLICATION = 'historyService.wsgi.application'
...
print(ourJWT.Decoder.pub_key, flush=True)
